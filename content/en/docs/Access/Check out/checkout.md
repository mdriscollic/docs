...
* Name: The patron’s name, displayed as [Firstname], [Preferred first name]. If there is no [Preferred first name](../../../users/#user-information) in the patron’s user record, then First name is displayed.
