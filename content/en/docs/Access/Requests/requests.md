...
|------------------------------------------------|--------------------------|------------|---------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inventory: View instances, holdings, and items | UI-Inventory Instance    | Data       | View    |     You need to have this permission to enable **Title look-up** when creating title level requests.                                                                                                                    |
