...
<table>
  ...
  <tr>
   ...
   <td>Charges added to an invoice in addition to the materials ordered. Shipping costs and taxes represent common adjustments.
   </td>
  </tr>
  <tr>
   <td>Allocated fund
  ...
  <tr>
   ...
   <td>A purchase order line contains one of the titles or packages being ordered by the library. Order lines make up an order. Orders can contain multiple order lines.
   </td>
  </tr>
  <tr>
   <td>Organization
  ...
  <tr>
   ...
   <td>The title of the ordered material. There may be one or more pieces attached.
   </td>
  </tr>
  <tr>
    <td>Resource</td>
...
<tr>
   ...
   <td>When used within the context of the Finance app, a record to keep track of a specific change to a budget. For instance, an allocation, a transfer, an encumbrance, a pending payment or a payment.
   </td>
  </tr>
  <tr>
   <td>User
  ...
  <tr>
   ...
   <td>To indicate that an order previously listed as “received” has not been delivered to the library.
   </td>
  </tr>
  <tr>
   <td>Vendor
...
<tr>
   <td>Vendor invoice number
   </td>
   <td>The number provided by the vendor for an invoice. This is in contrast to the FOLIO invoice number, which is a unique FOLIO value autogenerated by the system and applied to an invoice.
   </td>
  </tr>
  <tr>
